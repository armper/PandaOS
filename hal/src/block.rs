...
//!
//! This module provides a simple block device interface for reading sectors
//! from disk devices. Currently read-only.

/// Standard sector size for ATA/IDE devices
pub const SECTOR_SIZE: usize = 512;

/// Block device trait for reading disk sectors
